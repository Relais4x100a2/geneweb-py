...
from geneweb_py.core.family import MarriageStatus, ChildSex
...
def main():
    ...
    print(f"   - {joseph.display_name} (né le {joseph.birth_date}, décédé le {joseph.death_date})")
    ...
    print(f"   - Frères et sœurs de {jean.first_name}: {[s.display_name for s in siblings]}")
