...
class TestPersonalEvent:
    ...
    def test_personal_event_with_date(self):
        ...
        event = PersonalEvent(event_type=EventType.BIRTH, date=Date(year=2000))
        assert event.date.year == 2000

    def test_personal_event_with_place(self):
        """Test événement personnel avec lieu (ligne 139)"""
        event = PersonalEvent(event_type=EventType.BIRTH, place="Paris")
...
class TestFamilyEvent:
    ...
    def test_family_event_with_date(self):
        ...
        event = FamilyEvent(event_type=FamilyEventType.MARRIAGE, date=Date(year=2000))
        assert event.date.year == 2000
...
class TestEventEdgeCases:
    ...
    def test_event_with_all_fields(self):
        ...
        event = PersonalEvent(
            event_type=EventType.BIRTH, date=Date(year=2000), place="Paris"
        )
