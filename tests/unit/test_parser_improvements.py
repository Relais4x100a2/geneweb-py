...
class TestLexicalParserImprovements:
    ...
    def test_special_characters_in_occupations(self):
        ...
        occupation_text = ''.join(t.value for t in occupation_tokens if t.type != TokenType.EOF)
...
"""
        ...
        assert "Ceci est une note de base de données avec plusieurs lignes" in genealogy.metadata.database_notes[0]
