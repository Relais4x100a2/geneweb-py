...
class TestParseWarning:
    ...
    def test_parse_warning_with_context(self):
        ...
        warning = ParseWarning(
            "Date manquante", line_number=5, context="Personne: DUPONT Jean"
        )
...
class TestEnrichedErrorMessages:
    ...
    def test_error_to_dict(self):
        ...
        error = GeneWebParseError(
            "Erreur de test", line_number=10, token="test", severity=ErrorSeverity.ERROR
        )
...
class TestErrorRecovery:
    ...
    def test_multiple_errors_collection(self):
        ...
        parser.error_collector.add_error(GeneWebParseError("Erreur 1", line_number=1))
