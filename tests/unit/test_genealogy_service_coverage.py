...
class MockGenealogyServiceFileOperations:
    ...
    def test_load_from_file_error(self):
        ...
        with patch.object(
            service._parser, "parse_file", side_effect=Exception("Erreur de parsing")
        ):
...
class MockGenealogyServicePersonOperations:
    ...
    def test_create_person_success(self):
        ...
        person_data = PersonCreateSchema(
            surname="DUPONT", first_name="Jean", sex=Gender.MALE
        )
    ...
    def test_update_person_success(self):
        ...
        update_data = PersonUpdateSchema(
            first_name="Jean-Pierre", birth_date="01/01/1985"
        )
    ...
    def test_search_persons_by_name(self):
        ...
        person2_data = PersonCreateSchema(
            surname="DUPONT", first_name="Marie", sex=Gender.FEMALE
        )
        person3_data = PersonCreateSchema(
            surname="MARTIN", first_name="Pierre", sex=Gender.MALE
        )
    ...
    def test_search_persons_by_gender(self):
        ...
        person2_data = PersonCreateSchema(
            surname="MARTIN", first_name="Marie", sex=Gender.FEMALE
        )
    ...
    def test_search_persons_with_pagination(self):
        ...
        for i in range(10):
            person_data = PersonCreateSchema(
                surname="DUPONT", first_name=f"Person{i}", sex=Gender.MALE
            )
...
class MockGenealogyServiceFamilyOperations:
    ...
    def test_create_family_success(self):
        ...
        husband_data = PersonCreateSchema(
            last_name="DUPONT", first_name="Jean", gender=Gender.MALE
        )
        wife_data = PersonCreateSchema(
            last_name="MARTIN", first_name="Marie", gender=Gender.FEMALE
        )
    ...
    def test_create_family_with_children(self):
        ...
        child_data = PersonCreateSchema(
            last_name="DUPONT", first_name="Pierre", gender=Gender.MALE
        )
        child = service.create_person(child_data)

        family_data = FamilyCreateSchema(
            husband_id=husband.id, wife_id=wife.id, children_ids=[child.id]
        )
    ...
    def test_get_family_existing(self):
        ...
        family_data = FamilyCreateSchema(husband_id=husband.id, wife_id=wife.id)
    ...
    def test_update_family_success(self):
        ...
        update_data = FamilyUpdateSchema(
            marriage_date="01/01/2015", marriage_place="Lyon"
        )
    ...
    def test_search_families_by_husband(self):
        ...
        husband2_data = PersonCreateSchema(
            last_name="MARTIN", first_name="Pierre", gender=Gender.MALE
        )
        wife_data = PersonCreateSchema(
            last_name="DURAND", first_name="Marie", gender=Gender.FEMALE
        )
        ...
        family1_data = FamilyCreateSchema(husband_id=husband1.id, wife_id=wife.id)
        family2_data = FamilyCreateSchema(husband_id=husband2.id, wife_id=wife.id)
...
class MockGenealogyServiceEventOperations:
    ...
    def test_get_event_existing(self):
        ...
        event_data = PersonalEventCreateSchema(
            person_id=person.id, event_type=EventType.BIRTH, date="01/01/1990"
        )
    ...
    def test_update_event_success(self):
        ...
        update_data = EventUpdateSchema(date="02/01/1990", place="Lyon")
    ...
    def test_search_events_by_type(self):
        ...
        death_event_data = PersonalEventCreateSchema(
            person_id=person.id, event_type=EventType.DEATH, date="31/12/2020"
        )
...
class MockGenealogyServiceStats:
    ...
    def test_get_stats_detailed(self):
        ...
        family_data = FamilyCreateSchema(husband_id=person1.id, wife_id=person2.id)
...
class MockGenealogyServiceErrorHandling:
    ...
    def test_create_family_with_invalid_persons(self):
        ...
        family_data = FamilyCreateSchema(husband_id="invalid_id", wife_id="invalid_id")
    ...
    def test_create_event_with_invalid_person(self):
        ...
        event_data = PersonalEventCreateSchema(
            person_id="invalid_id", event_type=EventType.BIRTH, date="01/01/1990"
        )
