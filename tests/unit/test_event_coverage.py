...
class TestFamilyEvent:
    ...
    def test_family_event_post_init_marriage(self):
        ...
        event = FamilyEvent(
            event_type=EventType.BIRTH, family_event_type=FamilyEventType.MARRIAGE
        )
    ...
    def test_family_event_post_init_divorce(self):
        ...
        event = FamilyEvent(
            event_type=EventType.BIRTH, family_event_type=FamilyEventType.DIVORCE
        )
    ...
    def test_family_event_post_init_separation(self):
        ...
        event = FamilyEvent(
            event_type=EventType.BIRTH, family_event_type=FamilyEventType.SEPARATION
        )
    ...
    def test_family_event_post_init_engagement(self):
        ...
        event = FamilyEvent(
            event_type=EventType.BIRTH, family_event_type=FamilyEventType.ENGAGEMENT
        )
    ...
    def test_family_event_post_init_pacs(self):
        ...
        event = FamilyEvent(
            event_type=EventType.BIRTH, family_event_type=FamilyEventType.PACS
        )
