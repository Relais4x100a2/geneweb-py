...
from geneweb_py.core.exceptions import (
    GeneWebError, GeneWebParseError, GeneWebValidationError, 
    GeneWebEncodingError, GeneWebConversionError
)
...
class TestGeneWebConversionErrorCoverage:
    ...
    def test_gene_web_conversion_error_with_formats(self):
        ...
        error = GeneWebConversionError("Erreur de conversion", source_format="gw", target_format="gedcom")
        assert error.message == "Erreur de conversion"
...
class TestConversionErrorCoverage:
    ...
    def test_conversion_error_with_kwargs(self):
        ...
        error = ConversionError("Erreur de conversion", line_number=50, custom_attr="valeur")
        assert error.message == "Erreur de conversion"
