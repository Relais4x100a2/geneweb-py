...
class TestPersonIsAlive:
    ...
    def test_is_alive_explicit_false(self):
        ...
        person = Person(last_name="CORNO", first_name="Joseph", is_deceased=False)
        assert person.is_alive is True

    def test_is_alive_explicit_true(self):
        """Test is_alive avec is_deceased=True"""
        person = Person(last_name="CORNO", first_name="Joseph", is_deceased=True)
...
class TestPersonStringRepresentation:
    ...
    def test_str_representation(self):
        """Test __str__"""
        person = Person(last_name="CORNO", first_name="Joseph", nickname="Jo")
