...
class TestJSONImporter:
    ...
    def test_import_from_string_simple(self):
        ...
        json_data = {
            ...
            "persons": [
                {"id": 1, "last_name": "DUPONT", "first_name": "Jean", "gender": "m"}
            ],
            "families": [],
        }
            ...
            "persons": [
                {
                    ...
                    "last_name": "DUPONT",
                    "first_name": "Jean",
                    "birth_date": {"year": 1950, "month": 3, "day": 15},
                    "death_date": {"year": 2020, "month": 12, "day": 25},
                }
            ],
            "families": [],
        }
    ...
    def test_import_from_file(self):
        ...
        json_data = {
            "metadata": {"version": "1.0.0"},
            "persons": [{"id": 1, "last_name": "DUPONT", "first_name": "Jean"}],
            "families": [],
        }
