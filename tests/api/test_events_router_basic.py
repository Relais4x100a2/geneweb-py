"""
Tests de base pour le router events.py
"""
...
from geneweb_py.core.event import Event, EventType, PersonalEvent, FamilyEvent
...
def mock_service():
    ...
    service.get_event.return_value = personal_event
    service.create_personal_event.return_value = personal_event
    service.create_family_event.return_value = family_event
    service.update_event.return_value = personal_event
    service.delete_event.return_value = True
    service.search_events.return_value = ([personal_event, family_event], 2)
...
class TestEventsRouterBasic:
    """Tests de base pour le router events."""
