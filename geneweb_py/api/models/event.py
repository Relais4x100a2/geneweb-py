...
class EventBaseSchema(BaseModel):
    ...
    event_type: Union[EventType, FamilyEventType] = Field(..., description="Type d'événement")
...
class EventUpdateSchema(BaseModel):
    ...
    event_type: Optional[Union[EventType, FamilyEventType]] = Field(None, description="Type d'événement")
    date: Optional[str] = Field(None, description="Date de l'événement")
    place: Optional[str] = Field(None, description="Lieu de l'événement")
    reason: Optional[str] = Field(None, description="Raison ou cause")
    note: Optional[str] = Field(None, description="Note sur l'événement")
...
class EventSchema(EventBaseSchema):
    ...
    person_id: Optional[str] = Field(None, description="Identifiant de la personne (pour événements personnels)")
    family_id: Optional[str] = Field(None, description="Identifiant de la famille (pour événements familiaux)")
...
class EventSearchSchema(BaseModel):
    ...
    event_type: Optional[Union[EventType, FamilyEventType]] = Field(None, description="Filtrer par type d'événement")
    ...
    year_from: Optional[int] = Field(None, ge=1000, le=3000, description="Année minimum")
    ...
    has_witnesses: Optional[bool] = Field(None, description="Filtrer par présence de témoins")
    has_sources: Optional[bool] = Field(None, description="Filtrer par présence de sources")
...
class EventStatsSchema(BaseModel):
    ...
    personal_events: int = Field(..., ge=0, description="Nombre d'événements personnels")
