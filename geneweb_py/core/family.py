...
class Family:
    ...
    def add_child(self, person_id: str, sex: ChildSex = ChildSex.UNKNOWN, last_name: Optional[str] = None) -> None:
    ...
    def get_events_by_type(self, event_type: Union[EventType, FamilyEventType]) -> List[FamilyEvent]:
        ...
        if isinstance(event_type, EventType):
            ...
            if family_event_type:
                return [event for event in self.events if event.family_event_type == family_event_type]
        else:
            return [event for event in self.events if event.family_event_type == event_type]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'marriage_date': self.marriage_date.display_text if self.marriage_date else None,
            'marriage_place': self.marriage_place,
            'marriage_status': self.marriage_status.value,
            'divorce_date': self.divorce_date.display_text if self.divorce_date else None,
