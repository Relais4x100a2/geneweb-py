    ...
    def __init__(
        ...
        **kwargs,
        ...
        filtered_kwargs = {
            ...
            if k not in {"entity_type", "entity_id", "person_id", "validation_errors", "field", "value", "context", "severity"}
        }
        super().__init__(
            message,
            line_number=line_number,
...
class GeneWebErrorCollector:
    ...
    def add_warning(self, message: str, line_number: Optional[int] = None, 
        ...
        self.add_error(ParseWarning(message, line_number=line_number, 
    ...
    def get_errors(self, error_type: Optional[type] = None, 
                   severity: Optional[ErrorSeverity] = None) -> List[GeneWebError]:
