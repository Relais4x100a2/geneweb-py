...
class Person:
    ...
    families_as_child: List[str] = field(default_factory=list)  # IDs des familles où cette personne est enfant
    families_as_spouse: List[str] = field(default_factory=list)  # IDs des familles où cette personne est époux(se)
